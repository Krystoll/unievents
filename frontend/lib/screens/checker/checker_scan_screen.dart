...
class _CheckerScanScreenState extends State<CheckerScanScreen> {
  ...
  void initState() {
    ...
    _scannerController = MobileScannerController(
      ...
      // На ноутбуке в браузере — встроенная webcam; на телефоне — основная камера.
  ...
  Future<void> _handleCode(String qrToken) async {
        ...
        children: [
          ...
          ColoredBox(
            ...
            child: MobileScanner(
              ...
              // cover сильно увеличивает и обрезает превью на web — contain показывает весь кадр.
            ...
            child: Text(
              ...
              locked
                  ...
                  : kIsWeb
                      ...
                      ? 'Держите QR в рамке на расстоянии 20–30 см от камеры'
